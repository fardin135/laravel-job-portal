             ...
             <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                 <div
                     ...
                     <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item">
                             <a href="/admin/companies" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Companies</span>
                             </a>
                        <li class="nav-item">
                             <a href="/admin/jobs" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Jobs</span>
                             </a>
                         </li>
                        <li class="nav-item">
                             <a href="/admin/employees" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Employees</span>
                             </a>
                         </li>
                        <li class="nav-item">
                             <a href="/admin/blogs" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Blogs</span>
                             </a>
                         </li>
                        <li class="nav-item">
                             <a href="/admin/pages" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Pages</span>
                             </a>
                         </li>
                        <li class="nav-item">
                             <a href="/admin/plugins" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Plugins</span>
                             </a>
                         </li>
