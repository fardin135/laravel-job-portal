             ...
             <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                 <div
                     ...
                     <div
                         ...
                         <span class="fs-5 d-none d-sm-inline">Company Dashboard:</span>
             </div>
                     <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                         ...
                         <li class="nav-item">
                             <a href="/company/dashboard" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Dashboard</span>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a href="/company/jobs" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Jobs</span>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a href="/company/profile" class="nav-link align-middle px-0">
                                 <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Profile</span>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a href="/company/plugin" class="nav-link align-middle px-0">
